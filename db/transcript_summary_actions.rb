...
ACTIONS = [
  {
    action: "Develop an advertising campaign to focus on the particular needs of rural customers.",
    owner: "John Ruting"
  },
  {
    action: "Provide better customer information reporting to the rural sales teams.",
    owner: "Alice Linnes"
  },
  {
    action: "Conduct a survey to collect data on spending habits in rural areas.",
    owner: "Tiffany Ho"
  }
]
